...
import com.meroot.security.model.PositionDto;
...
public class PortfolioServiceTest {
	...
	public void setup() {
		...
		transactions.add(new Transaction(bitcoin, Type.BUY, new BigDecimal("3.1"), new BigDecimal("15000.00"), System.currentTimeMillis()));
		transactions.add(new Transaction(litecoin, Type.BUY, new BigDecimal("20.1"), new BigDecimal("200.00"), System.currentTimeMillis()));
		transactions.add(new Transaction(litecoin, Type.BUY, new BigDecimal("200.1"), new BigDecimal("100.00"), System.currentTimeMillis()));
	...
	public void testAddAndDeleteTransaction() {
		Transaction transaction = new Transaction(bitcoin, Type.BUY, new BigDecimal("3.6"), new BigDecimal("1500.00"), System.currentTimeMillis());
