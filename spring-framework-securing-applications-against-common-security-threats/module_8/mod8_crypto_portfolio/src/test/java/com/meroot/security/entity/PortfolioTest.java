...
public class PortfolioTest {
	...
	public void testAddTransaction() {
		...
		//When
		portfolio.addTransaction(new Transaction(bitcoin, Type.BUY, new BigDecimal(3.1), new BigDecimal(15000.00), System.currentTimeMillis()));
		//Then
	...
	public void testGetAllTransactionsForCoin() {
		...
		transactions.add(new Transaction(litecoin, Type.BUY, new BigDecimal(20.1), new BigDecimal(13000.00), System.currentTimeMillis()));
		transactions.add(new Transaction(litecoin, Type.BUY, new BigDecimal(200.1), new BigDecimal(130000.00), System.currentTimeMillis()));
		//When
